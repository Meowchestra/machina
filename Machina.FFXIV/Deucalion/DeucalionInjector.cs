...
#pragma warning restore CA1711 // Identifiers should not have incorrect suffix
        ...
        public static string ExtractLibrary()
        {
            ...
            string release_checksum = "64-10-52-9a-e2-2a-e5-9c-03-d4-28-b2-51-0c-78-d8-18-dd-ab-8c-4d-84-a9-e7-f5-39-de-03-7b-a7-6b-66"; // 1.1.0 CUSTOM
        ...
        public static bool InjectLibrary(int processId, string deucalionPath)
        {
            ...
            {
                if (process.Modules.Cast<ProcessModule>().Any(module => module.ModuleName == _resourceFileName))
                {
